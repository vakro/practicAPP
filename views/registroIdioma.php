 ...
 <div class="container">
   ...
   <div>
     <ul class="nav nav-tabs">
      ...
      <li role="presentation" class="active"><a href="#">Idiomas</a></li>
  ...
  <div class="container-fluid" >
    <div class="titulos" ><center><h3>IDIOMAS</h3></center></div><br>
      
      <form id="formIdiomas" class="form-horizontal" action="#" method="POST">   
        <div class="container1" id="contenedor">

          <div class="form-group">
            <label for="input-idioma" class="col-sm-3 control-label" name="idioma">Idioma: </label>
                <div class="col-sm-6">
          ...
          <div class="form-group">     
            <label for="input-nivel" class="col-sm-3 control-label" name="desc_nivel">Nivel: </label>
              <div class="col-sm-6">
                <select class="form-control" id="desc_nivel" name="desc_nivel">
      ...
      <center><button type="submit" class="btn btn-success" name="guardar" id="btnGuardarIdioma" value="Añadir" ><i class="fa fa-plus" aria-hidden="true" style="font-size:20px"></i> Añadir</button></center>                     
                          
      <legend></legend> 

      <div class="container1">
       <center><h4>Idiomas registrados</h4></center>
        <div id="tabla">
        <table class='table'>
           <tr>
             <th>IDIOMA</th>
  ...
  <nav aria-label="...">
    <ul class="pager">              
      <li><a href="registroOtros.php?idEst=<?=$_GET['idEst']?>">Atrás</a></li> 
      <li><a href="registroExperiencia.php?idEst=<?=$_GET['idEst']?>">Siguiente</a></li>
    </ul>
  </nav>                        
