...
<ul class="nav nav-tabs">
    <li><a href="verEmpresas.php">Ver Empresas</a></li>
    <li class="active"><a href="#">Registrar Empresa</a></li>     
</ul>
 
  <div class="container-fluid">
   <div class="titulos2" ><center><h3>REGISTRAR EMPRESA</h3></center></div><br> 
  </div>

  <div class="container1"> 
      <h4>Por favor ingrese los datos para guardar una empresa.</h4><br>   
      
      <form id="formEmpresa" class="form-horizontal" method="#" action="#">

        <div class="form-group">
            <label for="input-nit" class="col-sm-3 control-label" name="nombre_contacto">Nombre contacto: </label>
              <div class="col-sm-6">
        ...
        <div class="form-group">
            <label for="input-empresa" class="col-sm-3 control-label" name="nombre_empresa">Nombre empresa: </label>
              <div class="col-sm-6">
        ...
        <div class="form-group">
           <label for="input-telefono" class="col-sm-3 control-label" name="telefono">Número de contacto: </label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Ingrese el numero de contacto">
              </div>
        </div>
        ...
        <div class="form-group">
           <label class="col-sm-3 control-label">Correo: </label>
            <div class="col-sm-6">
              <input type="text" class="form-control" id="correo" name="correo" placeholder="Ingrese el correo electronico">
            </div>
        </div>

        <center><button type="submit" class="btn btn-success" name="guardar" id="btnGuardarEmpresa" value="Añadir">Guardar</button></center> 
