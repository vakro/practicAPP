...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="#">Registrar Usuario</a></li>     
     ...
     <div class="container-fluid">
        <div class="titulos2" ><center><h3>REGISTRO DE USUARIOS</h3></center></div><br> 
     </div>

    <div class="container1"> 
        
        <h4>Por favor ingrese los datos para crear una cuenta.</h4><br>

        <p style="color: black"><b>Recomendaciones: </b><br>
         * Ejemplo usuario: Uniajc2019<br> 
         * La contraseña debe tener entre 8 y 16 caracteres, al menos un dígito, al menos una minúscula y al menos una mayúscula.<br>
         * NO puede tener otros símbolos o caracteres especiales.<br>
         <b>Ejemplo: Practicapp520</b></p>

        <form id="formUsuario" class="form-horizontal" method="#">
            
           <div class="form-group">            
                <label class="col-sm-3 control-label" name="name"><i class="fa fa-id-badge" aria-hidden="true" style="font-size:28px"></i></label>             
             <div class="col-sm-6">   
                <input type="text" name="name" class="form-control" id="name" placeholder="Digite su nombre completo">                
             </div>
           </div>

           <div class="form-group ">             
                <label class="col-sm-3 control-label" name="username"><i class="fa fa-user" aria-hidden="true" style="font-size:28px"></i></label>            
                 <div class="col-sm-6">   
                    <input type="text" name="username" class="form-control" id="username" placeholder="Digite su nombre de usuario">               
                 </div>
           </div>  

            <div class="form-group">
              <label class="col-sm-3 control-label" name="email"><i class="fa fa-envelope" aria-hidden="true" style="font-size:28px"></i></label>             
              <div class="col-sm-6">
                <input type="email" name="email" class="form-control" id="email" placeholder="Digite su correo electrónico">               
              </div>
            </div> 

            <div class="form-group">
              <label class="col-sm-3 control-label" name="password"><i class="fa fa-unlock-alt" aria-hidden="true"  style="font-size:28px"></i></label>             
              <div class="col-sm-6">
                <input type="password" name="password" class="form-control" id="password" placeholder="Digite su contraseña">              
              </div>
            </div>
            
            <center><button type="submit" class="btn btn-success" name="guardar" id="btnGuardarUsuario" value="Añadir">Guardar</button></center>             
      </form>    
   </div>  
  </div>
  </div><br>
