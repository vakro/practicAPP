...
<nav class="navbar navbar-default" style="height: 92px;">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">     
     ...
     <div class="container-fluid">
        <div class="titulos2" ><center><h3>ACTUALIZAR USUARIO</h3></center></div><br> 
     </div>

    <div class="container1">

                
        <h4>Por favor digite su nueva contraseña.</h4><br>
        <p style="color: black">La contraseña debe tener entre 8 y 16 caracteres, al menos un dígito, al menos una minúscula y al menos una mayúscula.
        ...
        <form id="formUsuario" class="form-horizontal" method="#">
           ...
           <div class="form-group">            
             ...
             <div class="col-sm-6">   
                <input type="text" name="name" class="form-control" id="name" value="<?php echo $name?>" disabled>                
             </div>
           </div>

           <div class="form-group">            
                <label class="col-sm-3 control-label" name="username"><i class="fa fa-user-circle-o" aria-hidden="true" style="font-size:28px"></i></label>             
             <div class="col-sm-6">   
                <input type="text" name="username" class="form-control" id="username" value="<?php echo $user?>" disabled>                
             </div>
           </div>
           ...
           <div class="form-group">            
             ...
             <div class="col-sm-6">   
                <input type="text" name="email" class="form-control" id="email" value="<?php echo $email?>" disabled>                
             </div>
           </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="password" name="password" class="form-control" id="password" placeholder="Digite su nueva contraseña" required="">              
              </div>
            </div>

            <input type="hidden" name="id" class="form-control" id="id" value="<?php echo $id?>"> 
            
            <center><button type="submit" class="btn btn-success" name="guardar" id="btnActualizarUsuario" value="Añadir">Actualizar</button></center>             
      </form>    
   </div>  
  </div>
  </div><br>
...
<script type="text/javascript" src="../js/actualizarUsuario.js"></script>
